...
const mockEvents: Event[] = [
  {
    ...
    location: "Stade de Dakar",
    isOnline: false,
    description: "Le plus grand festival électronique de l'année avec des DJs internationaux.",
    imageUrl: "/placeholder.svg",
    capacity: 5000,
    ticketPrice: 75,
    organizerId: "2",
    organizerName: "Productions Musicales Dakar",
    createdAt: "2025-01-10T14:23:15",
    ticketCategories: [
      { id: "1-1", name: "Standard", price: 75, quantity: 4000, eventId: "1" },
      { id: "1-2", name: "VIP", price: 150, quantity: 1000, eventId: "1" }
    ],
    ticketsSold: 3450
  },
  {
                ...
                {filteredEvents.length > 0 ? (
                  filteredEvents.map((event) => (
                    <TableRow key={event.id}>
                      ...
                      <TableCell>{calculateRevenue(event).toLocaleString()} €</TableCell>
                      <TableCell>
                    ...
                    <div className="space-y-2">
                      ...
                      <div>
                        ...
                        <div className="text-lg font-semibold">
                          {calculateRevenue(event).toLocaleString()} €
                        </div>
                      </div>
                    </div>
                  </CardContent>
