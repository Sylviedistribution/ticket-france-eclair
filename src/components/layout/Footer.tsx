      ...
      <div className="container px-4 py-12 mx-auto">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <Link to="/terms" className="hover:text-eticket-accent">Conditions d'utilisation</Link>
              </li>
              <li>
                <Link to="/privacy" className="hover:text-eticket-accent">Politique de confidentialité</Link>
              </li>
              <li>
                <Link to="/refund" className="hover:text-eticket-accent">Politique de remboursement</Link>
              </li>
              <li>
                <Link to="/cookies" className="hover:text-eticket-accent">Politique des cookies</Link>
              </li>
            </ul>
          </div>
